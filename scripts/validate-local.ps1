...
Assert-FileContains (Join-Path $addonRoot "docs\QUICKSTART.md") "scripts\\test-example-startup.bat" "quickstart docs"
Assert-FileContains (Join-Path $addonRoot "docs\QUICKSTART.md") "./scripts/test-example-startup.sh" "quickstart docs"
...
Assert-FileContains (Join-Path $addonRoot "docs\AUDIO_WORKFLOWS.md") "test-example-startup.bat" "audio workflow docs"
Assert-FileContains (Join-Path $addonRoot "docs\AUDIO_WORKFLOWS.md") "generated artifacts" "audio workflow docs"
Assert-FileContains (Join-Path $addonRoot "docs\RELEASE_CHECKLIST.md") "test-example-startup.bat" "release checklist"
...
Assert-FileContains (Join-Path $transcribeExampleRoot "src\ofApp.cpp") "gui\.draw\(\)" "transcribe example manual ImGui render"
...
Assert-FileContains (Join-Path $liveMicExampleRoot "src\ofApp.cpp") "gui\.draw\(\)" "live mic example manual ImGui render"
