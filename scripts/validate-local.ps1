...
Assert-FileContains (Join-Path $scriptRoot "build-transcribe-example.ps1") "OFXIMGUI_GLFW_FIX_MULTICONTEXT_SECONDARY_VP=1" "transcribe example build script ImGui backend flags"
