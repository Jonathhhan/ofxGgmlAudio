...
try {
	...
	Assert-FileContains $releaseNotes "OFXGGML_AUDIO_VERSION_STRING.*1\.0\.1" "v1.0.1 release notes"
	Assert-FileContains $releaseNotes "does not claim general media decoding" "v1.0.1 release notes"
