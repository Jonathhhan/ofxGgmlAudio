...
This repository is `ofxGgmlAudio`, the audio companion addon for the ofxGgml family.

Codex should treat `ofxGgmlCore` as the shared backend-neutral foundation. This repo owns Whisper, transcription, denoising, voice/audio workflows, audio examples, and audio-specific model integration.

## Addon contract

Do:

- keep audio-specific workflows in this addon
